...
import { Credit, Movie } from '../../../model/credit';
...
export class CreditCreateComponent {
  ...
  constructor(private creditSvc: CreditService, private movieSvc: MovieService, private actorSvc: ActorService, private router: Router) { }
